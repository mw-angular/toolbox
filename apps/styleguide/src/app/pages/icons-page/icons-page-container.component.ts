...
export class IconsPageContainerComponent {
  items: ReadonlyMap<DsIconCategory, IconsPageItem[]>;
  ...
  private getItems(): ReadonlyMap<DsIconCategory, IconsPageItem[]> {
    const items: Map<DsIconCategory, IconsPageItem[]> = new Map();
